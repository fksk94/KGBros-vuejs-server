...
#### 태완이의 후기😁
 ...
 프로젝트를 벌써 3번이나 같이한 페어와 함께 해서 충돌도 없고 서로 잘 이해하며 재밌게 프로젝트를 끌어나가서 너무 좋았습니다. 연정이의 해피한 성격때문에 팀 프로젝트하면서 잠도 많이 못 자고 주말도 없이 진행했지만 매일 잠을 한 하루에 20시간 잔듯한 상쾌한 기분이었습니다. 연정아 고마워~!!  😆

 백엔드와 프론트엔드 둘 다 접하면서 많이 배운 것 같습니다.  특히 Axios와 container 쪽은 마스터한 느낌이에요 ㅎㅎㅎ;; API도 이제 다른 것들 보면서 많이 쓸 수 있을 것 같고, Key 숨기는 방법도 다양한 것을 알아냈습니다. 배포도 해보면서 제가 진짜 현업 개발자가 된 것 같아 기분도 좋았고, PPT에, 영상에, 웹, APP, 배포까지 성취감이.. 진짜 엄청 난 것 같습니다. 또, 좋은 프로젝트 포트폴리오도 만든 것 같아 기분이 좋습니다. 2학기 프로젝트도 진짜 기대되고 우리 "연정이를 구하라구!" 조 오래 갔으면 좋겠습니당~ㅎㅎ

아! 맞다 ㅎㅎ 김구브라더스 앱 꼭 써보세요!! 👍👍 전 한 번씩 보고싶은 영화를 todo앱에 저장하는데 이젠 이 영화앱 진짜로 쓸 것 같아요.  사용자 기반 추천도 해주니까 좋아하는 영화를 나의 리스트에 넣고 계속 돌리다 보면 진짜 보고싶은 영화가 나올 걸요? 
